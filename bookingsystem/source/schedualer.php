    ...
    <div class="booking-system__body">
        ...
        <div class="tab isInactive isRHS" id="chose-duration">
            <div class="tab__body justify">
                            ...
                            <div class="time-picker__section hours-section">
                                <div class="time-picker__next time-picker__controll">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                         ...
                                         width="512px" height="512px"><g
                                                transform="matrix(-4.28626e-16 -1 1 -4.28626e-16 3.55271e-15 41.999)">
                                ...
                                <div class="time-picker__prev time-picker__controll disabled">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                         ...
                                         style="enable-background:new 0 0 41.999 41.999;" xml:space="preserve"
                                         width="512px" height="512px"><g
                                                transform="matrix(5.51091e-16 1 -1 5.51091e-16 41.999 -7.10543e-15)">
                                            <path d="M36.068,20.176l-29-20C6.761-0.035,6.363-0.057,6.035,0.114C5.706,0.287,5.5,0.627,5.5,0.999v40  c0,0.372,0.206,0.713,0.535,0.886c0.146,0.076,0.306,0.114,0.465,0.114c0.199,0,0.397-0.06,0.568-0.177l29-20  c0.271-0.187,0.432-0.494,0.432-0.823S36.338,20.363,36.068,20.176z"
                                                  data-original="#000000" class="active-path"/>
                                        </g> </svg>
                                </div>
                ...
                <button id="" class="booking-system__button next-button ">Pick a Time</button>
            </div>
        </div>
        <div class="tab isInactive isRHS" id="chose-datetime">
            <div class="tab__body justify">
                ...
                <button id="continue-service-select-btn" class="booking-system__button next-button hidden">Book Now
                </button>
            </div>
        </div>
                ...
                <div class="tab__inner-body">
                    <div class="customer-info">
                        ...
                        <form id="registration-form" class="not-action">
                            ...
                            <div class="custom-input">
                                <div class="cutom-input__icon"></div>
                                <input type="text" name="aptnumber" tabindex="-1" autocomplete="off"
                    ...
                    <div class="customer-info">
                        ...
                        <form id="new-password-form" class="not-action">
                            ...
                            <div class="custom-checkbox">
                                ...
                                <label for="terms-of-service">I agree to Motil's <a tabindex="-1"
                                                                                    href="https://www.motil.us/terms-of-service"
        ...
        <div class="tab isInactive isRHS" id="add-card">
            <div class="tab__body">
                    ...
                    <div class="customer-info">
                        <div class="info-box">
                            <div class="info-box__content">
                                ...
                                <div class="info-box__text">
                                    We will not charge your card until after your service is completed. Motil does not
                                    store your complete credit card information for your security.
                                </div>
                            </div>
                        </div>
                ...
                <button id="continue-service-select-btn" class="booking-system__button next-button">Complete Booking
                </button>
            </div>
        </div>
        <div class="tab isInactive isRHS" id="select-account">
            <div class="tab__body">
                ...
                <div>
                    <button id="continue-service-select-btn" class="booking-system__button next-button">Continue
                    </button>
        ...
        <div class="tab isInactive isRHS" id="booking-status">
            <div class="tab__body">
                ...
                <button id="back-to-home-btn" class="booking-system__button next-button hidden">Back to the home page
                </button>
            </div>
        </div>
...
<!--                        </div>-->
                    ...
                    <div class="add-specialist-trigger">
                        <div>Book another specialist</div>
                    </div>
                    <div class="add-specialist-form info-box hidden">
                        <form id="add-specialist-form" class="not-action">
                            <div class="close">X</div>
                            <div class="add-specialist-form__header">
                                Add Specialist by id
                            </div>
                            <div class="input-row">
                                <input type="text" tabindex="-1" autocomplete="off" placeholder="x" maxlength="1">
                                <input type="text" tabindex="-1" autocomplete="off" placeholder="x" maxlength="1">
                                <input type="text" tabindex="-1" autocomplete="off" placeholder="x" maxlength="1">
                                <input type="text" tabindex="-1" autocomplete="off" placeholder="x" maxlength="1">
                                <input type="text" tabindex="-1" autocomplete="off" placeholder="x" maxlength="1">
                            </div>
                            <button id="add-specialist-btn" class="booking-system__button">Add new specialist
                            </button>
                        </form>
                    </div>
                </div>
...
<script src="assets/js/main.min.js?v=40"></script>
